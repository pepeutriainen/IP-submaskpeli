# Graph Report - IP-submaskpeli  (2026-09-22)

## Corpus Check
- 37 files · ~492,938 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 169 nodes · 229 edges · 27 communities (23 shown, 4 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 16 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9777ea6d`
...
4. `getNodeSubnetScope()` - 7 edges
5. `getBitwiseAndBreakdown()` - 7 edges
6. `ip2long()` - 7 edges
7. `createNode()` - 6 edges
8. `openIpModal()` - 6 edges
9. `calculateSubnetDetails()` - 6 edges
10. `getOrLoadModel()` - 5 edges
...
## Knowledge Gaps
- **49 isolated node(s):** `masterStarLevels`, `levels`, `nodeTypes`, `IP_REQUIRED_TYPES`, `LINK_TYPES` (+44 more)
